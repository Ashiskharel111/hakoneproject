  ...
  const toursCatalog = [
    ...
    },
    {
      ...
      highlights: [
        ...
        { ja: '名勝 三溪園の広大な日本庭園', zh: '古典名胜三溪园移筑古建筑群', fr: 'Jardin traditionnel Sankeien', es: 'Jardín traditionnel Sankeien', en: 'Sankeien Traditional Japanese Gardens' }[lang],
    ...
    },
    {
      ...
      highlights: [
        { ja: '全車4WD・最新スタッドレスタイヤ', zh: '全系全时四驱及专业雪地轮胎', fr: 'Véhicules 4x4 pneus neige', es: 'Vehículos 4x4 neumáticos neige', en: '4WD Vehicles & Bridgestone Snow Tires' }[lang],
